...
public class ReviewRepositoryImpl implements ReviewRepositoryCustom {
	...
	public Slice<ReviewEntity> findSliceByFoodId(Long foodId, Pageable page) {
		List<ReviewEntity> reviews = queryFactory.select(QReviewEntity.reviewEntity).from(QReviewEntity.reviewEntity)
		...
		return new SliceImpl<>(reviews.stream().limit(page.getPageSize()).toList(), page,
